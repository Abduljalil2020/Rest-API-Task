...
//
// class OrdersDetailsScreenTest extends StatelessWidget {
//   Model model;
//
//   OrdersDetailsScreenTest({
//     required this.model,
//   });
//   @override
...
//
//        // var model = TaskCubit.get(context).orderModel;
//         return Scaffold(
//             appBar: AppBar(
//               title: Text(
//                 'تفاصيل الطلب',
...
//
//
//   // Widget buildDetailsItem(Model model, context, index) => Padding(
//   //   //  TaskOrderModel? models= TaskCubit.get(context).orderModel;
//   //
//   //   padding: const EdgeInsets.all(20.0),
//   //   child: Column(
//   //     children: [
...
//   //         child: Image(
//   //           image: NetworkImage(
//   //               'https://api.ghanmeen.com${model.orderImages![index].path.toString()}'
//   //           ),
//   //           width: 150,
//   //           height: 75,
//   //           fit: BoxFit.contain,
...
//   //                   'https://api.ghanmeen.com${model.user!.profileImagePath.toString()}',
//   //                 ),
//   //               ),
//   //             ],
//   //           ),
...
//   //   condition: model.model!.length > 0,
//   //   builder: (context) => ListView.separated(
//   //     physics: BouncingScrollPhysics(),
//   //     itemBuilder: (context, index) =>
//   //         buildDetailsItem(model.model![index], context, index),
